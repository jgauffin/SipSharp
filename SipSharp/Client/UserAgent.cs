...
namespace SipSharp.Client
{
   ...
   /// features are also supported through encryption of bodies using
    ...
    public class UserAgent
    {
        ...
        private ILogger _logger = LogFactory.CreateLogger(typeof (UserAgent));
        ...
        public IRequest CreateRequest(string method, Contact from, Contact to)
        {
            ...
            // Section 10. 
            Request request = new Request(method, from.Uri, "SIP/2.0");
            request.From = from;
            ...
            // Section 16.7 Item 3.
            ViaEntry viaEntry = new ViaEntry(_endPoint.Address.ToString(), CreateBranch());
   ...
   /// of response processing in the TU is method specific.  However, there
        ...
        private void OnResponse(object sender, ResponseEventArgs e)
        {
            ...
            {
                _logger.Info("Dropping response (received from '" + e.RemoteEndPoint +
        ...
        private bool Process4xx(IClientTransaction transaction, IResponse response)
        {
            ...
            {
                IRequest request = (IRequest)transaction.Request.Clone();
                Authenticate authenticate = (Authenticate)response.Headers[Authenticate.WWW_NAME];
